...
const ListenClicks = require("../models/ListenClicks");
...
const sendVerificationEmail = async (user) => {
  try {
    ...
    const mailOptions = {
      from: config.email,
      to: user.email,
      subject: "Undervalued Music - Email Verification",
      html: `<p>Almost there!</p>
      
      <p>Click <a href="https://undervaluedmusic.com/verification/${verificationToken}">here</a> to verify your email.</p>`,
    };
...
router.delete("/delete", authMiddleware, async (req, res) => {
  try {
    ...
    await ListenClicks.delete(userId);
